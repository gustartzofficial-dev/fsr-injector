...
float3 draw_native_ui(float3 color, float2 pos) {
    ...
    if (scoutMotion > 0.5) white = max(white, text_pixel(77,86,32,79,70,76,79,87,32,32,32,32, pos, o + float2(0, 234), 2.0)); // MV OFLOW
